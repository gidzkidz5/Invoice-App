    ...
    <>
      ...
      <nav className={`${theme}`} id="navbar">
        ...
        <div id="themelogo-container">
          {session && <div id="logout" onClick={logoutHandler} title="Logout">
            <LogoutTwoToneIcon 
              sx={{color: "#7E88C3"}}
            />
          </div>}
          {!session && !loading && <div id="login" onClick={loginHandler} title="Login">
            <LoginRoundedIcon 
              sx={{color: "#7E88C3"}}
            />
          </div>}
          {session && <div id="profile" onClick={profilePageHandler} title="Change Password">
          <KeyIcon
              sx={{color: "#7E88C3"}}
            />
          </div>}
          <div id="themelogo" onClick={switchTheme} title="Switch Theme">
           {theme === 'light' ? <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
